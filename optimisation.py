...
def minimax(piecesPlayer,gridListener, heuristique, player, initial_player,maximisant=True, profondeur=4):
    i = 0
    for elem in piecesPlayer[player]:
        for version in elem.values():
...
def alpha_beta(piecesPlayer,gridListener, heuristique, player,initial_player, maximisant=True, profondeur=4,alpha=-inf,beta=inf):
    i = 0
    for elem in piecesPlayer[player]:
        for version in elem.values():
            if len(gridListener.calc_possibilities(player, version)) != 0:
